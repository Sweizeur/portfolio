  ...
  return (
    <>
      <motion.div
        ...
        className="w-5 h-5 fixed bg-[#ffffff]/40 rounded-full pointer-events-none"
        animate={{
          width: cursorSize,
          height: cursorSize,
        }}
      ...
      <motion.div
        ...
        className="w-2 h-2 fixed -translate-x-1/2 -translate-y-1/2 border rounded-full pointer-events-none"
      />
    </>
  );
}